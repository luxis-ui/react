    ...
    <Box>
        ...
        <Stack gap="md">
          ...
          <Flex justify="between" align="center" style={{ marginTop: 4 }}>
            ...
            <Typography variant="body2">
              <Link to="/forgot-password" style={{ color: 'var(--lxs-color-primary-600)', textDecoration: 'none', fontWeight: 500 }}>
                Forgot Password?
              </Link>
            </Typography>
          </Flex>
      ...
      <Flex justify="center" style={{ marginTop: 24 }}>
        <Typography variant="body2" style={{ color: 'var(--lxs-color-neutral-500)' }}>
          ...
          <Link to="/register" style={{ color: 'var(--lxs-color-primary-600)', textDecoration: 'none', fontWeight: 600 }}>
            Sign Up
          </Link>
        </Typography>
      </Flex>
